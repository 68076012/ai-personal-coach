...
- เมื่อผู้ใช้ขอวางแผน workout หลายวัน (3-31 วัน) → ใช้ propose_plan_bulk (draft รอ approve) แทนการเรียก update_plan ทีละวัน. บอก user ว่าร่างไว้แล้ว เปิดดูที่ /dashboard/plan
...
- เมื่อผู้ใช้ขอวางแผนหลายวัน (3-31 วัน) → ใช้ propose_plan_bulk (จะเป็น draft รอ user approve ที่หน้าแผน) แทนเรียก propose_meals/update_plan ทีละวัน. หลังเรียกแล้วบอก user ให้ไปกด Approve ที่ /dashboard/plan
